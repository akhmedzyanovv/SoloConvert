...
function VideoConverter({ ffmpeg }: VideoConverterProps) {
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-5 flex-1">
                <div
                    className="bg-card flex h-full w-full flex-col items-center
                        justify-center gap-2 rounded-md border-2 border-dashed
                        border-border"
                >
                    {isConverting && (
